...
function BureldehCom(props) {
    return (
        <div className='w-full sm:w-[50%] md:w-[40%] h-[200px] mb-[320px] relative flex items-center justify-center flex-col'>
            <button className="w-[500px] h-36">
                    <a href={props.href}>
                        <div className="w-full h-[50%] flex flex-row">
                            <div className="px-[5%] aspect-[89.16/64.8] w-auto flex items-center justify-center">
                                <img
                                    src={props.img}
                                    className="aspect-square w-full sm:w-4/6 min-[912px]:w-5/6 min-[1074px]:w-full"
                                />
                            </div>
                            <h2 className="flex items-center text-left h-full w-auto font-extrabold text-[14px] sm:text-[12px] min-[850px]:text[18px] min-[1074px]:text-[18px] text-blue-900">
                                {props.name}
                            </h2>
                        </div>
                        ...
                        <div className="w-full h-[400px] overflow-scroll">
                            <div className="w-full h-[100px] relative">
                                <div className="w-full h-4/6 sm:h-5/6 absolute mt-5">
